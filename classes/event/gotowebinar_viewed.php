...
namespace mod_gototraining\event;
defined('MOODLE_INTERNAL') || die();


class gototraining_viewed extends \core\event\base {
    /**
     * Init method
     */
    protected function init() {
        ...
        $this->data['objecttable'] = 'gototraining';
    }
    ...
    public static function get_name() {
        return get_string('gototrainingviewed', 'mod_gototraining');
    }
    ...
    public function get_url() {
        return new \moodle_url("/mod/gototraining/view.php",
